    ...
    <div className='pt-10'>
      ...
      <div className="flex flex-col lg:flex-row mt-10 gap-10">
        ...
        <div className="lg:w-1/2 flex items-center">
          <div>
            <h1 className='text-2xl md:text-4xl font-bold mb-5'>Lorem ipsum dolor sit amet, consectetur adipiscing elit</h1>
            ...
            <button className='bg-primary bg-opacity-0 border border-text hover:bg-opacity-50 py-2 px-4 mt-3'>Read More</button>
          </div>
